/**
 * base64 工具
 * 来源:https://github.com/dankogai/js-base64
 */
layui.define(['chromeToolBase','chromeTool', 'jquery'], function (exports) {
    (function (global) {
        "use strict";
    ...
    var $ = layui.$;
    var chrome_tool_base64 = function(tool_id){
        ...
        tool.loadComplete = function () {
            ...
            $("#" + id + ' .submit_button').on('click', function () {
                ...
                var operation = data.operation === "encode" ? "encode" : "decode";
                var result = Base64[operation](data.tool_input_content);
    ...
    exports('chrome_tool_base64', chrome_tool_base64);
});